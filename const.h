...
const int INVENTORY_CELLS_POSITION_START_X = INVENTORY_POSITION_X + 22;
const int INVENTORY_CELLS_POSITION_START_Y = INVENTORY_POSITION_Y + 20;
...
const int POKEMON_INVENTORY_WIDTH = 22;
const int POKEMON_INVENTORY_HEIGHT = 22;
...
// After catching popup

const std::string AFTER_CATCHING_POPUP_TEXT_SUCCESS = "You caught\na Pokemon!";
const std::string AFTER_CATCHING_POPUP_TEXT_FAIL = "You missed\nthe Pokemon!";

const int AFTER_CATCHING_POPUP_LAYOUT_WIDTH = 170;
const int AFTER_CATCHING_POPUP_LAYOUT_HEIGHT = 90;

const int AFTER_CATCHING_POPUP_LAYOUT_X = WINDOW_WIDTH / 2 - AFTER_CATCHING_POPUP_LAYOUT_WIDTH / 2;
const int AFTER_CATCHING_POPUP_LAYOUT_Y = WINDOW_HEIGHT / 2 - AFTER_CATCHING_POPUP_LAYOUT_HEIGHT / 2;

const int AFTER_CATCHING_POPUP_TEXT_SIZE = 36;

const int AFTER_CATCHING_POPUP_TEXT_X = AFTER_CATCHING_POPUP_LAYOUT_X + 20;
const int AFTER_CATCHING_POPUP_TEXT_Y = AFTER_CATCHING_POPUP_LAYOUT_Y + 20;

const int AFTER_CATCHING_POPUP_BUTTON_WIDTH = 50;
const int AFTER_CATCHING_POPUP_BUTTON_HEIGHT = 16;

const int AFTER_CATCHING_POPUP_BUTTON_X = AFTER_CATCHING_POPUP_LAYOUT_X + AFTER_CATCHING_POPUP_LAYOUT_WIDTH / 2 - AFTER_CATCHING_POPUP_BUTTON_WIDTH / 2;
const int AFTER_CATCHING_POPUP_BUTTON_Y = AFTER_CATCHING_POPUP_LAYOUT_Y + AFTER_CATCHING_POPUP_LAYOUT_HEIGHT - AFTER_CATCHING_POPUP_BUTTON_HEIGHT - 20;
...
const int BATTLE_POKEMON_WIDTH = 80;
const int BATTLE_POKEMON_HEIGHT = 80;
