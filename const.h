...
const int CHEST_INTERFACE_BUTTON_CLOSE_WIDTH = INVENTORY_BUTTON_CLOSE_WIDTH * 4;
const int CHEST_INTERFACE_BUTTON_CLOSE_HEIGHT = INVENTORY_BUTTON_CLOSE_HEIGHT *4;