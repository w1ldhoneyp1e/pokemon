...
const int TRAINER_POSITION_Y = PLAYER_START_POSITION_Y - 40;

// Battle 

const int BATTLE_ARROW_WIDTH = 57;
const int BATTLE_ARROW_HEIGHT = 162;
...
const int BATTLE_POKEMON_WIDTH = 200;
const int BATTLE_POKEMON_HEIGHT = 200;
